...
Sometimes you have data coming from different places or in different files, and you want to put them together so you can analyze them. In the tidyverse, this is called "joining".
