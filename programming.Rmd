...
And as a last step, let's save this figure. We use `paste` here to construct the path to the file, which is in a folder that we have called "figures." We will show more about how this is useful later. 
...
## add title and save
  ...
  ggsave(filename = paste("figures","Afghanistan_gdpPercap.png", sep = "/"), plot = my_plot,
         width = 15, height = 10)
```

```{r, echo = F}
#this chunk is evaluated but not shown (chunk above is shown in rendered ouput) to prevent
#inconsistency in the "figures" path name
...
## add title and save
  ...
  ggsave(filename = file.path("img","Afghanistan_gdpPercap.png"), plot = my_plot,
         width = 15, height = 10)
```
