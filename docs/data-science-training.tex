...
\includegraphics{data-science-training_files/figure-latex/unnamed-chunk-48-1.pdf}
...
\begin{Highlighting}[]
\NormalTok{gapminder %>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(continent ==}\StringTok{ 'Asia'}\NormalTok{) %>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(country) %>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(lifeExp ==}\StringTok{ }\KeywordTok{max}\NormalTok{(lifeExp)) %>%}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{gap_normal <-}\StringTok{ }\NormalTok{gap_normal %>%}\StringTok{ }
...
\NormalTok{gap_to_plot <-}\StringTok{ }\NormalTok{gapminder %>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(country ==}\StringTok{ "Afghanistan"}\NormalTok{)}

\NormalTok{## plot}
\NormalTok{my_plot <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data =} \NormalTok{gap_to_plot, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \NormalTok{year, }\DataTypeTok{y =} \NormalTok{gdpPercap)) +}\StringTok{ }
\StringTok{  }\KeywordTok{geom_point}\NormalTok{() +}
...
\NormalTok{for( cntry in country_list )\{}
  ...
  \NormalTok{## filter the country to plot}
  \NormalTok{gap_to_plot <-}\StringTok{ }\NormalTok{gapminder %>%}
\StringTok{    }\KeywordTok{filter}\NormalTok{(country ==}\StringTok{ }\NormalTok{cntry) }
...
\NormalTok{gap_europe <-}\StringTok{ }\NormalTok{gapminder %>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(continent ==}\StringTok{ "Europe"}\NormalTok{) %>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{gdpPercap_cummean =} \NormalTok{dplyr::}\KeywordTok{cummean}\NormalTok{(gdpPercap))}

\NormalTok{country_list <-}\StringTok{ }\KeywordTok{unique}\NormalTok{(gap_europe$country) }\CommentTok{# ?unique() returns the unique values}

\NormalTok{for( cntry in country_list )\{ }\CommentTok{# (cntry = country_list[1])}
  
  \NormalTok{## filter the country to plot}
  \NormalTok{gap_to_plot <-}\StringTok{ }\NormalTok{gap_europe %>%}
\StringTok{    }\KeywordTok{filter}\NormalTok{(country ==}\StringTok{ }\NormalTok{cntry)}
  ...
  \NormalTok{## plot}
  \NormalTok{my_plot <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data =} \NormalTok{gap_to_plot, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \NormalTok{year, }\DataTypeTok{y =} \NormalTok{gdpPercap_cummean)) +}\StringTok{ }
\StringTok{    }\KeywordTok{geom_point}\NormalTok{() +}
\StringTok{    }\NormalTok{## add title and save}
\StringTok{    }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \KeywordTok{paste}\NormalTok{(cntry, }\StringTok{"GDP per capita"}\NormalTok{, }\DataTypeTok{sep =} \StringTok{" "}\NormalTok{))}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{x <-}\StringTok{ }\NormalTok{countries_list %>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{estimated =} \KeywordTok{runif}\NormalTok{(}\KeywordTok{length}\NormalTok{(country), }\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{)) %>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{estimated =} \KeywordTok{round}\NormalTok{(estimated))}

\NormalTok{x$estimated[x$estimated ==}\StringTok{ }\DecValTok{0}\NormalTok{] =}\StringTok{ "no"}
\NormalTok{x$estimated[x$estimated ==}\StringTok{ }\DecValTok{1}\NormalTok{] =}\StringTok{ "yes"}
\NormalTok{readr::}\KeywordTok{write_csv}\NormalTok{(x, }\StringTok{'data/countries_estimated.csv'}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{gapminder_est <-}\StringTok{ }\NormalTok{gapminder %>%}
...
\NormalTok{## create a list of countries}
\NormalTok{gap_europe <-}\StringTok{ }\NormalTok{gapminder_est %>%}\StringTok{ }\NormalTok{## use instead of gapminder}
\StringTok{  }\KeywordTok{filter}\NormalTok{(continent ==}\StringTok{ "Europe"}\NormalTok{) %>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{gdpPercap_cummean =} \NormalTok{dplyr::}\KeywordTok{cummean}\NormalTok{(gdpPercap))}

\NormalTok{country_list <-}\StringTok{ }\KeywordTok{unique}\NormalTok{(gap_europe$country) }
...
\StringTok{    }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \KeywordTok{paste}\NormalTok{(cntry, }\StringTok{"GDP per capita"}\NormalTok{, }\DataTypeTok{sep =} \StringTok{" "}\NormalTok{))}
  ...
  \NormalTok{if (gap_to_plot$estimated ==}\StringTok{ "yes"}\NormalTok{) \{}
...
\StringTok{    }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \KeywordTok{paste}\NormalTok{(cntry, }\StringTok{"GDP per capita"}\NormalTok{, }\DataTypeTok{sep =} \StringTok{" "}\NormalTok{))}
  ...
  \NormalTok{## if estimated, add that as a subtitle. }
  \NormalTok{if (}\KeywordTok{any}\NormalTok{(gap_to_plot$estimated ==}\StringTok{ "yes"}\NormalTok{)) \{ }\CommentTok{# any() will return a single TRUE or FALSE}
