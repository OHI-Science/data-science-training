...
\subsection{\texorpdfstring{\texttt{complte}: other \texttt{tidyr}
awesomeness}{complte: other tidyr awesomeness}}\label{complte-other-tidyr-awesomeness}

\begin{itemize}
\tightlist
\item
  \texttt{complete()} For this, let's look at Jarrett Byrnes' blog on
  the topic:
\end{itemize}
