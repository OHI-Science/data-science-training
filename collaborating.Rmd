...
We aren't going to talk about branches very much, but they are a powerful feature of git/GitHub. I think of it as creating a copy of your work that becomes a parallel universe that you can work in safely because it's not affecting your work. By default, you begin with one branch called 'master'. When you create new branches, you can call them whatever you want. However, if you call one `gh-pages` (all lowercase, with a - and no spaces), this will let you create a website. So let's do this together: 
...
<img src="img/github-branch.png" width="250px">

Let's type `gh-pages`. 

<img src="img/github_create-branch_gh-pages.png" width="250px"> 
...
<img src="img/github_branch2.png" width="250px"> 
...
<img src="img/github-change-branch.png" width="250px"> 
