...
- [cheatsheet](https://www.rstudio.com/wp-content/uploads/2015/03/ggplot2-cheatsheet.pdf)- [Interactive Plots and Maps - Environmental Informatics](http://ucsb-bren.github.io/env-info/wk06_widgets.html)  
...
georegion_one | lowerer resolution UN georegion designations based on georegional and social similarities | character | Africa, Americas, Asia
...
Plots are created using a step-wise approach that allows for extensive flexibility and customization of plots.  
...
Next we will replace geom_point() with geom_jitter() to create a style of plot with the same data. geom_jitter, which is nearly the same as a scatter plot but it adds some random variation in the x-axis to separate points:
...
Now we will work on some other geoms.
