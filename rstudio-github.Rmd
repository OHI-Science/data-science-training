...
1. add a few files and sync: pull, stage, commit, push
1. explore github.com: files, commit history, file history, blame
1. practice: edit/add files and sync with an R script
...
Let's also explore commit history, file history, blame.
