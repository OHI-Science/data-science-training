...
This is a 2-day training workshop to learn R, RStudio, Git, and GitHub. You will learn a reproducible workflow that can be used in analyses of all kinds, including Ocean Health Index assessments. This is really powerful, cool stuff: I made and published this book using these tools and workflow.

We will practice learning three main tools and practices all at the same time: coding with best practices (R/RStudio), collaborative version control (Git/GitHub), and communication/publishing (R markdown/GitHub). This training will teach these all together to reinforce these tools and practices, because that is how you'll work in your own projects. 
...
This material builds from a lot of materials developed by others. In particular, it pulls from the following resources, which are extremely excellent and highly recommended for further learning and as resources later on. Specific lessons will also cite more resources.
